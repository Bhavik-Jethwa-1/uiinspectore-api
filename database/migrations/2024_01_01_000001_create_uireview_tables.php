...
return new class extends Migration
{
    ...
    {
        // Users table (extend default) — only if is_admin column doesn't exist yet
        ...
        // Projects — only if table doesn't exist
        ...
        // Screenshots — only if table doesn't exist
        ...
        // Reviews — only if table doesn't exist
        ...
        // Review Scores — only if table doesn't exist
        ...
        // Review Issues — only if table doesn't exist
        if (!Schema::hasTable('review_issues')) {
        ...
        // Review Annotations — only if table doesn't exist
        if (!Schema::hasTable('review_annotations')) {
        ...
        // Review Suggestions — only if table doesn't exist
        if (!Schema::hasTable('review_suggestions')) {
